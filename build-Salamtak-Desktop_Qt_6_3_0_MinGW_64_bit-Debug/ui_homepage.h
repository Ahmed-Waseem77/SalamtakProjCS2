...
""));
        ...
        myaccount = new QPushButton(widget);
        myaccount->setObjectName(QString::fromUtf8("myaccount"));
        myaccount->setFont(font);
        myaccount->setCursor(QCursor(Qt::PointingHandCursor));
        myaccount->setStyleSheet(QString::fromUtf8("QPushButton {color: white; border-radius: 6px;min-width: 80px;}"));
        myaccount->setFlat(true);

        gridLayout->addWidget(myaccount, 0, 4, 1, 1);
    ...
    void retranslateUi(QMainWindow *Homepage)
    {
        ...
        myaccount->setText(QCoreApplication::translate("Homepage", "My Account", nullptr));
